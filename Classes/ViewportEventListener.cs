...
public unsafe class ViewportEventListener(AtkEventListener.Delegates.ReceiveEvent eventHandler) : CustomEventListener(eventHandler) {
    public void AddEvent(AtkEventType eventType, AtkResNode* node) => Services.Framework.RunOnFrameworkThread(() => {
    ...
    public void RemoveEvent(AtkEventType eventType) => Services.Framework.RunOnFrameworkThread(() => {
