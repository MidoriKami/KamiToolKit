...
internal unsafe class RadioButtonNode : ComponentNode<AtkComponentRadioButton, AtkUldComponentDataRadioButton> {
    ...
    /// Not intended for public use, but it's here if you absolutely need it.
    /// </summary>
    public ImageNode SelectedImageNode { get; }

    /// <summary>
    /// Not intended for public use, but it's here if you absolutely need it.
    /// </summary>
    public ImageNode UnselectedImageNode { get; }

    /// <summary>
    /// Action that is called when this radio button is selected.
    /// </summary>
    public Action? Callback { get; set; }

    /// <summary>
    /// Gets or sets the displayed label for this radio button.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// This will not cause the other buttons to become deselected when setting.
    /// </remarks>
    ...
    /// <summary>
    /// Gets or sets whether to show this radio button as selected.
    /// </summary>
    /// <remarks>
    /// This does not set it as checked internally.
    /// </remarks>
