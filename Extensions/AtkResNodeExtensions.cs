...
/// <summary>
/// Extension methods for AtkResNode, these are very handy, highly recommend 10/10
/// </summary>
public static unsafe class AtkResNodeExtensions {
    extension(ref AtkResNode node) {
        ...
        /// <summary>
        /// Gets the nodes rotation angle in degrees, if setting will update the nodes state.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets if the node should be visible, if setting will update the nodes state.
        /// </summary>
        public bool Visible {
            get => node.IsVisible();
        ...
        /// <summary>
        /// Gets if this node is actually visible by checking each parent node to see if they are all visible.
        /// </summary>
